    ...
    public void handleMessage(final Message<?> message) throws MessagingException {
        ...
        if (message.getPayload() instanceof String) {
            Optional.ofNullable(message.getHeaders())
                    ...
                    .map(Object::toString)
                    .flatMap(CompanyConsumeAction::getActionFromString)
                            ...
                            case BUCKET_CREATED:
                                ...
                                if (BucketRequest.BucketType.COMPANY.getValue().equalsIgnoreCase(bucketResponse.getType())) {
                                    ...
                                    do {
                                        ...
                                        BucketPermissionResponse bucketPermissionResponse = this.createBucketPermissionResponse(bucketResponse.getBucketId(),
                            ...
                            case USER_STATUS_UPDATED:
                                ...
                                userResponse.getUserRoles()
                                        ...
                                        .filter(userRole -> userRole.getRole()
                                                .equalsIgnoreCase(UserRole.ROLE_BROKER.getValue())
                                                || userRole.getRole().equalsIgnoreCase(UserRole.ROLE_COMPANY_ADMIN.getValue()))
                                        .forEach(userRole -> {
