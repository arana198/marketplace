...
class BrokerDocumentServiceImpl implements BrokerDocumentService {
    ...
    */
    ...
    public List<BrokerDocumentResponse> getBrokerDocuments(final String userId,
        ...
        log.info("Getting broker [ {} ] documents", brokerProfileId);
    ...
    public void addDocument(final String userId,
        ...
        log.info("Add broker [ {} ] document", brokerProfileId);
        ...
        final FileRequest fileRequest = fileRequestConverter.getFileRequest(brokerProfile.getBrokerProfileId(), multipartFile.getOriginalFilename(), "Broker Certificate", FileType.BROKER_CERTIFICATE);
